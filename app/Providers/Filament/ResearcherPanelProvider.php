...
class ResearcherPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            '))
            ->discoverResources(in: app_path('Filament/Researcher/Resources'), for: 'App\Filament\Researcher\Resources')
            ->discoverPages(in: app_path('Filament/Researcher/Pages'), for: 'App\Filament\Researcher\Pages')
            ->pages([
                Dashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/Researcher/Widgets'), for: 'App\Filament\Researcher\Widgets')
            ->widgets([
                AccountWidget::class,
